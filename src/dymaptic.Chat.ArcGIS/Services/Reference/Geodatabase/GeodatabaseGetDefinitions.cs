...
namespace SDKExamples
{
  ...
  public class GeodatabaseGetDefinitions
  {
    ...
    {
      // Opens a file geodatabase  This will open the geodatabase if the folder exists and contains a valid geodatabase. //Need to get a root path to a file geodatabase on disk.
